...
get_filename_component(_filename "C:/Users/gbrill/catkin_ws/src/rplidar_ros/srv/msg/tilter.srv" NAME_WE)
add_custom_target(_rplidar_ros_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rplidar_ros" "C:/Users/gbrill/catkin_ws/src/rplidar_ros/srv/msg/tilter.srv" ""
)
...
_generate_srv_cpp(rplidar_ros
  "C:/Users/gbrill/catkin_ws/src/rplidar_ros/srv/msg/tilter.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rplidar_ros)
  install(CODE "execute_process(COMMAND \"C:/opt/python27amd64/python.exe\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rplidar_ros\")")
  # install generated code
  install(
